...
TIMEOUT_KEEP_ALIVE = 600 # 5  # seconds
...
async def lifespan(app: fastapi.FastAPI):
    ...
    # RunVar("_default_thread_limiter").set(CapacityLimiter(500))
...
if __name__ == "__main__":
    ...
    openai_serving_chat_v2 = OpenAIServingChatV2(engine, model_config,
                                            ...
                                            chat_template=args.chat_template)
    openai_serving_completion = OpenAIServingCompletion(
        engine, model_config, served_model_names, lora_modules=args.lora_modules,
        prompt_adapters=None, request_logger=None)
    openai_serving_embedding = OpenAIServingEmbedding(
        engine, model_config, served_model_names, request_logger=None)
